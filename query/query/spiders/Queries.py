...
class Questions(scrapy.Spider):
    ...
    start_urls = [
        "https://stackoverflow.com/questions?tab=unanswered&page=1"
    ]
    ...
    def parse(self, response):
        ...
        next_page = "https://stackoverflow.com/questions?tab=unanswered&page=" + str(Questions.pages)
        if(Questions.pages <= 100):
            Questions.pages += 1
